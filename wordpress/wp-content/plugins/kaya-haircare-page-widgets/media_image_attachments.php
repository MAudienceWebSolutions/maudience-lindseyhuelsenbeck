<?php
$globel_custom_options = array(    
    'image_custom_link' => array(
        'label'       => __('Custom link', 'globel'),
        'input'       => 'text',
        'helps'       => __('Ex:http://www.google.com', 'globel'),
        'application' => 'image',
        'exclusions'  => array('audio', 'video'),
        'required'    => false,
        //'error_text'  => __('Copyright field required', 'globel')
    ),
    'link_new_window' => array(
        'label'       => __('Target', 'globel'),
        'input'       => 'select',
        'options' => array(
            '_blank' => __('_blank','globel'),
            '_self' => __('_self','globel')
        ),
        'application' => 'image',
        'exclusions'   => array('audio', 'video')
    )
...
Class Globel_Custom_Media_Options {
...
$globel_media_custom_options = new Globel_Custom_Media_Options( $globel_custom_options );
?>