	...
	theme = {
		...
		----------------------------*/
	 	_init : function(){
    		...
    		if (api.options.autoplay){
			 ...
			 $(vars.slide_caption).stop(true,true).animate({'opacity':1},250,'swing',function(){ (api.getField('title')) ? $(vars.slide_caption).html(api.getField('title')) : $(vars.slide_caption).html('');
			}); 
		  	...
		  	// Update slide caption
		   	...
		   	if ($(vars.slide_caption).length){
				(api.getField('title')) ? $(vars.slide_caption).html(api.getField('title')) : $(vars.slide_caption).html('');
		   		//(api.getField('title')) ? $(vars.slide_caption).html(api.getField('title')) : $(vars.slide_caption).html('');
		   		$(vars.slide_caption).stop(true,true).animate({'opacity':'0'},0,'swing', function(){ 
		...
		----------------------------*/
	 	afterAnimation : function(){
	 		...
	 		$(vars.slide_caption).stop(true,true).animate({'opacity':1},750,'swing', function(){    });
	 	},
