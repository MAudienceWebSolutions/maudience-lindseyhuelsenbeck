...
class sidebar_generator {
   ...
   public  function sidebar_generator(){
    ...
    static function admin_menu(){
        add_theme_page('Sidebar Generator', 'Sidebar Generator', 'manage_options', 'multiple_sidebars', array('sidebar_generator','admin_page'));
        ...
        <div class="wrap">
            ...
            <table class="widefat page" id="sbg_table" style="width:600px;">
                ...
                <?php
                    ...
                    ?>
                    <tr>
                        <td colspan="3"><?php _e( 'No Sidebars defined','haircare') ?></td>
                    </tr>
                    <?php
                }
                ?>
        ...
        <div id="sbg_box" class="postbox " >
            ...
            <div class="inside">
                <div class="sbg_container">
                    ...
                    <p><?php _e( 'Please select the sidebar you would like to display on this page. <strong>Note:</strong> You must first create the sidebar under Appearance > Sidebars.','haircare') ?>
                    </p>
                    <ul>
                    <?php 
                    ...
                    //var_dump($wp_registered_sidebars);        
                        for($i=0;$i<1;$i++){ ?>
                            ...
                            <select name="sidebar_generator[<?php echo $i?>]" style="display: none;">
                                <option value="0"<?php if($selected_sidebar[$i] == ''){ echo " selected";} ?>><?php _e( 'WP Default Sidebar','haircare'); ?></option>
                            <?php
                            $sidebars = sidebar_generator::get_sidebars();
                            if(is_array($sidebars) && !empty($sidebars)){
                                foreach($sidebars as $sidebar){
                            ...
                            <select name="sidebar_generator_replacement[<?php echo $i?>]">
                             <option value="sidebar" <?php if($selected_sidebar_replacement[$i] == ''){ echo " selected";} ?>><?php _e( 'Sidebar','haircare'); ?></option>
                            <?php
