...
if ( !class_exists( 'RWMB_Select1_Field' ) )
{
	class RWMB_Select1_Field extends RWMB_Field
	{
		/**
		 ...
		 * @return void
		 */
		static function kaya_admin_enqueue_scripts()
		{
		...
		static function options_html( $field, $meta )
		{
			...
			foreach ( $field['options'] as $value => $label )
			{
				$html .= sprintf(
					$option,
					$label,
					selected( in_array( $label, (array)$meta ), true, false ),
					$label
				);
			}
